...
void MyGame::RegisterComponents(GameTypeRegistry* registry)
{
    ...
    registry->RegisterComponent<SpringArmComponent>("Spring Arm",
        [](entt::registry& reg, entt::entity entity, nlohmann::json& json)
        {
            auto& comp = reg.get<SpringArmComponent>(entity);
            json["TargetArmLength"] = comp.TargetArmLength;
            json["TargetOffset"] = comp.TargetOffset;
            json["Pitch"] = comp.Pitch;
            json["Yaw"] = comp.Yaw;
            json["SensitivityX"] = comp.SensitivityX;
            json["SensitivityY"] = comp.SensitivityY;
            json["MinPitch"] = comp.MinPitch;
            json["MaxPitch"] = comp.MaxPitch;
            json["LerpSpeed"] = comp.LerpSpeed;
        },
        [](entt::registry& reg, entt::entity entity, const nlohmann::json& json)
        {
            auto& comp = reg.get_or_emplace<SpringArmComponent>(entity);
            comp.TargetArmLength = json.value("TargetArmLength", 0.0f);
            comp.TargetOffset = json.value("TargetOffset", glm::vec3(0.0f, 0.0f, 0.0f));
            comp.Pitch = json.value("Pitch", 0.0f);
            comp.Yaw = json.value("Yaw", 0.0f);
            comp.SensitivityX = json.value("SensitivityX", 0.0f);
            comp.SensitivityY = json.value("SensitivityY", 0.0f);
            comp.MinPitch = json.value("MinPitch", 0.0f);
            comp.MaxPitch = json.value("MaxPitch", 0.0f);
            comp.LerpSpeed = json.value("LerpSpeed", 0.0f);
        },
        [](entt::registry& reg, entt::entity entity)
        {
            auto& comp = reg.get<SpringArmComponent>(entity);

            LXUI::DrawDragFloat("Target Arm Length", comp.TargetArmLength, 0.5f, 0.0f, FLT_MAX);
            LXUI::DrawVec3Control("Target Offset", comp.TargetOffset);
            LXUI::DrawDragFloat("Pitch", comp.Pitch, 0.5f, 0.0f, FLT_MAX);
            LXUI::DrawDragFloat("Yaw", comp.Yaw, 0.5f, 0.0f, FLT_MAX);
            LXUI::DrawDragFloat("SensitivityX", comp.SensitivityX, 0.5f, 0.0f, FLT_MAX);
            LXUI::DrawDragFloat("SensitivityY", comp.SensitivityY, 0.5f, 0.0f, FLT_MAX);
            LXUI::DrawDragFloat("MinPitch", comp.MinPitch, 0.5f, 0.0f, FLT_MAX);
